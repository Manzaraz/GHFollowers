...
//  GHFollowers
//
//  Created by Christian Manzaraz on 05/08/2024.
//
...
class SearchVC: UIViewController {
    ...
    @objc func pushFollowerListVC() {
        ...
        navigationController?.pushViewController(followerListVC,
                                                 animated: true)
    }
    
    func configureLogoImageView() {
        view.addSubview(logoImageView) // ten en cuenta de que si olvidas esta linea, el logoImageView no se agregará a la vista y no la podrás configurar como lo haces en las lineas de abajo
